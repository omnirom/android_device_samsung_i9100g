...
public class SensorsFragmentActivity extends PreferenceFragment {
    ...
    private static final String FILE_ACCELEROMETER_CALIB = "/sys/devices/virtual/sensors/accelerometer_sensor/calibration";
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } else if (key.compareTo(DeviceSettings.KEY_ACCELEROMETER_CALIBRATE) == 0) {
    ...
    public static void restore(Context context) {
        ...
        boolean accelerometerCalib = sharedPrefs.getBoolean(DeviceSettings.KEY_ACCELEROMETER_CALIBRATION, true);
